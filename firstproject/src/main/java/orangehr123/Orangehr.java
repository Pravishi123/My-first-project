...
public class Orangehr {
    public static void main(String[] args) {
        ...
        WebElement userRoleDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//label[text()='User Role']/../..//div[contains(@class,'oxd-select-text-input')]")));
        userRoleDropdown.click();

        // Select ESS option
        WebElement essOption = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[@role='option']//span[text()='ESS']")));
        essOption.click();
        
        driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[2]/div/div[2]/div/div/input")).sendKeys("Pravishi");
        
     // Click Status dropdown
        WebElement statusDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//label[text()='Status']/../..//div[contains(@class,'oxd-select-text-input')]")));
